...
void init_ssd1306(ssd1306_t *ssd) {
...
// Função para desenhar o display
void draw_display(ssd1306_t *ssd, char* str_red, char* str_green, char* str_blue, char* str_clear, char* str_lux) {
  ssd1306_fill(ssd, false);
  ssd1306_rect(ssd, 3, 3, 122, 60, true, false);
  ssd1306_line(ssd, 3, 15, 123, 15, true);
  ssd1306_vline(ssd, 64, 16, 62, true);
  ssd1306_draw_string(ssd, "SENSOR COR/LUX", 8, 6);
  ssd1306_draw_string(ssd, "R:", 7, 20);
  ssd1306_draw_string(ssd, str_red, 25, 20);
  ssd1306_draw_string(ssd, "G:", 7, 30);
  ssd1306_draw_string(ssd, str_green, 25, 30);
  ssd1306_draw_string(ssd, "B:", 7, 40);
  ssd1306_draw_string(ssd, str_blue, 25, 40);
  ssd1306_draw_string(ssd, "C:", 7, 50);
  ssd1306_draw_string(ssd, str_clear, 25, 50);
  ssd1306_draw_string(ssd, "LUX:", 68, 20);
  ssd1306_draw_string(ssd, str_lux, 68, 30);
  ssd1306_send_data(ssd);
}